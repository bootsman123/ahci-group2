...
In this appendix we will give a quantitative estimate of the amound of work done by each member of the group. Note that our initial intention for the project was to communicate with the multi-touch table using smarphones. For this purpose, we had to develop an Android application for the smartphones and set up a server for the Android aplication to communicate with the multi-touch table. Despite the fact that we did not manage to make this work in time, a lot of work has been spent on this.
\noindent
 \begin{tabular}{ l  c c c r }
                                                   
  \textbf{Time spent working on:}  & Bas Bootsma & Bas Kooiker & Roland Meertens & Thomas Planting \\
  The game& 60 & 0 &  65&30\\
  The multi-touch table& 0 & 0&11&0 \\
  The appplication& 0 & 40&0&0 \\
  The server &16 & 0 &0&0\\
  The usability study&0&8&0&0\\
  The report &8 & 10&8&20\\
